...
InDirectory = r'C:\Users\Dell\Documents\GitHub\Athena-Vortex-Lattice-Python\Windows\AVL Files\In'   
AlphaRange = [0,3,6,9,12,15] 
for conf in range(RootChords.size):
    for alpha in AlphaRange:
        CreateConfFile(Ref,RootChords,TipChords,conf,BaseAVLInputFileName,InDirectory) 
